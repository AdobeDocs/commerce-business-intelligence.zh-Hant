...
| `Subsequent Order Probability` | 下過訂單的客戶下另一個訂單的可能性，依訂單編號細分。 也就是說，一次下單、第二次下單的客戶比例、第二次下單的客戶比例，等等。 |
...
| 後續順序機率 | 下過訂單的客戶再下一個訂單的可能性，依訂單編號細分。 也就是說，一次下單次下單的百分比，二次下三次下單的百分比，以此類推。 |
