...
此範例使用名為`Day number of the month`的自訂維度。 如果您要建立此報告，但您的Data Warehouse中尚未有此維度，請[連絡支援](https://experienceleague.adobe.com/docs/commerce-knowledge-base/kb/troubleshooting/miscellaneous/mbi-service-policies.html)以取得協助。
